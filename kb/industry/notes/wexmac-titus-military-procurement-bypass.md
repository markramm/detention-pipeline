---
id: wexmac-titus-military-procurement-bypass
title: "WEXMAC-TITUS — How ICE Bypasses Normal Contracting Using Military Procurement"
type: note
tags:
- wexmac
...
# WEXMAC-TITUS: The Military Procurement Bypass
...
- **[[geo-group|GEO Group]]** — Added February 2026; largest private prison operator. $254M profit in 2025 (700% increase), at least 6 former ICE officials in leadership. No-bid pathway to $65B.
- **[[corecivic|CoreCivic]]** — Second-largest private prison operator
...
- **[[mtc|Management & Training Corp (MTC)]]** — Private prison operator
...
This is the financial mechanism that makes the Detention Reengineering Initiative possible. Without it, converting 24 warehouses into detention facilities by September 30, 2026 would require 24 separate competitive procurements — each subject to protest, disclosure, and delay. With WEXMAC-TITUS, ICE issues task orders and [[geo-group|GEO]] starts building.
...
| Feature | GSA Normal | WEXMAC-TITUS |
|---------|-----------|-------------|
| Appraisals | Required (Uniform Relocation Act) | No evidence obtained |
| Competition | Full and open | Pre-qualified vendor pool |
| Congressional notice | Required above thresholds | Not required for task orders |
| Transparency | Public posting | Task orders not advertised |
| Bid protests | Full GAO rights | Limited for IDIQ task orders |
| Environmental review | NEPA required | Bypassed in several cases |
...
- [Warren/Shaheen letter to Hegseth (March 22, 2026)](https://www.warren.senate.gov/newsroom/press-releases/warren-shaheen-press-hegseth-on-diversion-of-military-resources-to-build-immigrant-detention-centers-demand-pentagon-end-agreement-with-dhs)
- [Warren/Raskin letters to contractors (March 29, 2026)](https://www.warren.senate.gov/newsroom/press-releases/warren-raskin-lead-45-lawmakers-in-investigating-contractors-real-estate-firms-involved-in-trumps-expansion-of-inhumane-warehouse-detention-centers)
- [Spotlight PA: Trump admin bypasses public scrutiny](https://www.spotlightpa.org/berks/2026/03/pennsylvania-ice-detention-centers-secret-contracts-trump-federal-government/)
- [GovCon Wire: Navy Expands WEXMAC TITUS to 109 Companies](https://www.govconwire.com/articles/navy-wexmac-titus-contract-109-companies)
