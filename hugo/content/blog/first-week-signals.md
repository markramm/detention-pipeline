...
Twenty county fights documented. Nine states investigated. The [coverage gaps page](https://detention-pipeline.transparencycascade.org/coverage/) shows where the data is still thin. The [contribute page](https://detention-pipeline.transparencycascade.org/contribute/) explains how to submit what you know.

---

*Data current as of April 12, 2026. The Detention Pipeline is at [detention-pipeline.transparencycascade.org](https://detention-pipeline.transparencycascade.org/).*
